...
| `/register` | Auth/Register | Farmer registration |
| `/dashboard` | Dashboard | Farmer overview, active crop lots |
| `/crop-lots/new` | CropLot/Create | Create new crop lot |
| `/crop-lots/:id` | CropLot/Detail | Lot details |
| `/analysis/:cropLotId` | Analysis/Main | Full decision analysis |
| `/markets` | Market/List | Market price browser |
...
| # | Component | App | Priority |
|---|-----------|-----|----------|
| 1 | Project scaffold | — | P0 |
| 2 | Django settings, Docker, env | — | P0 |
| 3 | User model + JWT auth | accounts | P0 |
| 4 | FarmerProfile CRUD | accounts | P0 |
| 5 | CropLot CRUD | crops | P0 |
| 6 | Market + MarketPrice models | markets | P0 |
| 7 | Mock market data seeder | markets | P0 |
| 8 | Market price APIs | markets | P0 |
| 9 | Nearby market discovery | markets | P0 |
| 10 | Transport cost tool | tools | P0 |
| 11 | Net value calculation | tools | P0 |
| 12 | Historical price analytics | markets | P0 |
| 13 | Price forecasting (SARIMAX) | forecasting | P0 |
| 14 | SELL/HOLD/PARTIAL SELL engine | decisions | P0 |
| 15 | IBM Granite advisory | agents | P0 |
| 16 | Orchestrator service | agents | P0 |
| 17 | React frontend scaffold | frontend | P0 |
| 18 | Login/Register UI | frontend | P0 |
| 19 | CropLot UI | frontend | P0 |
| 20 | Analysis/Dashboard UI | frontend | P0 |
| 21 | Price charts (Recharts) | frontend | P0 |
| 22 | End-to-end integration test | tests | P0 |

---

## 17. Phased Implementation Plan

### PHASE 0 — Project Setup (Batch 1)
...
- CropLot model + serializer + ViewSet
- CRUD endpoints
- Ownership enforcement
- Validation (commodity, quantity, dates)
- Unit tests
...
- Price list API
- Price history API
- Nearby markets API (PostGIS or distance formula)
- Market comparison tool

### PHASE 4 — Financial Engine (Batch 5)
- `financial_tools.py`: transport, net value, storage, ROI
- `market_tools.py`: compare, price change
...
### PHASE 10 — Integration + Testing + Demo Hardening (Batch 11)
