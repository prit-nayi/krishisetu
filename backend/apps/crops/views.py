...
class CropLotViewSet(viewsets.ModelViewSet):
    """CRUD for a farmer's crop lots. Farmers can only access their own lots."""
    ...
    def get_queryset(self):
        ...
        return CropLot.objects.filter(farmer=farmer_profile, is_active=True).order_by("-created_at")
