...
class CustomTokenObtainPairSerializer(TokenObtainPairSerializer):
    """JWT token serializer — adds user role to token payload."""
...
class FarmerProfileSerializer(serializers.ModelSerializer):
    """Serializer for FarmerProfile CRUD."""
    ...
    class Meta:
        model = FarmerProfile
        fields = (
            "id", "user", "district", "taluka", "village",
...
class FarmerProfileCreateSerializer(serializers.ModelSerializer):
    """Serializer for creating/updating a farmer profile (no user nesting)."""
